...
urlpatterns = patterns('',
                       ...
                       # url(r'friendship-test', views.friendship_test, name='friendship-test'),
                       url(r'user/(?P<username>\w+)/get-notebooks', views.get_notebooks, name='get-notebooks'),
                       url(r'add-notebook', views.add_notebook, name='add-notebook'),
